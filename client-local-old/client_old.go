...
func runCommands() error {
	...
	cmd2 := exec.Command("go", "run", "/home/sven/go/src/osquery-extension-ssh-json/server/extension.go", "--socket", "/home/sven/.osquery/shell.em")
	...
	err = sendQuery(ptmx2, "select * from users")
	if err != nil {
		return err
	}
